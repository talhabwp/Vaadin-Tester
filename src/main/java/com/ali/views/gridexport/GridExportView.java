package com.ali.views.gridexport;

import com.ali.views.MainLayout;
...
@PageTitle("Grid Export")
@Route(value = "data-grid", layout = MainLayout.class)
public class GridExportView extends Div {
